...
function tabs() {
  ...
  const setActiveContent = () => {
    if (body.querySelector('.pure-tabs__content_active')) {
      body
        .querySelector('.pure-tabs__content_active')
        .classList.remove('pure-tabs__content_active');
    }
    body
      .querySelector(`[data-tab=${getActiveTabName()}]`)
      .classList.add('pure-tabs__content_active');
  };
  ...
  top.addEventListener('click', (e) => {
    ...
    if (top.querySelector('.pure-tabs__caption_active')) {
      top.querySelector('.pure-tabs__caption_active').classList.remove('pure-tabs__caption_active');
    }
